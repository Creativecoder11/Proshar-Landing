      ...
      <div className="container max-w-[1440px] mx-auto px-4 flex flex-col items-center text-center relative z-10">
        ...
        <TextAnimation type="words" delay={1} duration={1.5}>
          <h1 className="text-4xl md:text-7xl font-semibold tracking-tight mb-6 max-w-5xl text-white leading-none md:leading-[1.1]">
            <p>The Ultimate B2B</p>
            <span className="flex items-center justify-center">
              <p>Sourcing Platform</p>
              <p className="text-[#FF5E32] ml-2 font-playfair italic font-semibold">
                Proshar
              </p>
            </span>
          </h1>
        ...
        <TextAnimation delay={1.5} duration={1.5}>
          <p className="text-white text-base md:text-lg max-w-2xl mb-10 leading-normal tracking-[-0.4px]">
            Source directly from the best wholesalers. Compare prices, pick products,
            and get direct delivery. The all-in-one sourcing platform for retailers.
          </p>
        </TextAnimation>
